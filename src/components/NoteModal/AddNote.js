    ...
    return (
        <>
            <div className="d-grid gap-2 col-6 mx-auto">
                <button className="btn btn-secondary" type="button" data-bs-toggle="modal" data-bs-target="#addNote">Add TASK.... <i className="fa-solid fa-pen"></i></button>
            </div>
                            ...
                            <form id='addModal' onSubmit={submitForm}>
                                <div className="row">
                                    <div className="col-md-12 form-group m-2">
                                        ...
                                        <input type="text" ref={inp1} className="form-control note-grey" name="title" id="title" onChange={handler} required/>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-12 form-group m-2">
                                        <label htmlFor="desc" className="form-label d-flex justify-content-start">Write your TASK</label>
                                        <textarea className="form-control note-grey" ref={inp2} name="desc" id="desc" cols="30" rows="7" onChange={handler} required></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
